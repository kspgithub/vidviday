    ...
    <main>
        <div class="container">
            ...
            <ul class="bread-crumbs" itemscope itemtype="https://schema.org/BreadcrumbList">
                ...
                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <span itemprop="name">{{ __('Вакансії') }}</span>
                    ...
                    <div>
                        @foreach($vacancies as  $vacancy)
                            <div class="bordered-box vacancy">
                                ...
                                <x-seo-button :code="'goto.vacancy'" href="{{$vacancy->url}}" class="btn type-3 btn-more">Дізнатись Більше</x-seo-button>
                            </div>
                        @endforeach
                    </div>
                    <!-- CAREER CONTENT END -->
                ...
                <div class="col-xl-4 col-12">
                    ...
                    <x-page.right-sidebar :pageContent="$pageContent">
                        <div class="sidebar-item" v-is="'vacancy-form'"
                             form-title="{{ __('common.vacancy.form-title') }}"
                             form-sub-title="{{ __('common.vacancy.form-sub-title') }}"
                        ></div>
