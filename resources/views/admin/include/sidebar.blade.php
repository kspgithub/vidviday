        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{routeActiveClass('admin.user*')}}">
                ...
                <ul id="users"
                    ...
                    <li class="sidebar-item {{routeActiveClass('admin.user.index')}}"><a class="sidebar-link"
                                                                                         href="{{route('admin.user.index')}}">@lang('Users List')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.user.create')}}"><a class="sidebar-link"
            ...
            <li class="sidebar-item {{routeActiveClass('admin.tour*')}}">
                ...
                <ul id="tours"
                    ...
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.tour.*')}}"><a class="sidebar-link"
                                                                                     href="{{route('admin.tour.index')}}">@lang('Tours')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.badge.*')}}"><a class="sidebar-link "
                                                                                      href="{{route('admin.badge.index')}}">@lang('Badges')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.tour-group.*')}}"><a class="sidebar-link"
                                                                                           href="{{route('admin.tour-group.index')}}">@lang('Groups')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.tour-subjects.*')}}"><a class="sidebar-link "
                                                                                              href="{{route('admin.tour-subjects.index')}}">@lang('Subjects')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.direction.*')}}"><a class="sidebar-link "
                                                                                          href="{{route('admin.direction.index')}}">@lang('Directions')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.tour-type.*')}}"><a class="sidebar-link "
            ...
            <li class="sidebar-item {{routeActiveClass('admin.location*')}}">
                ...
                <ul id="location"
                    ...
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.country.index')}}"><a class="sidebar-link"
                                                                                            href="{{route('admin.country.index')}}">@lang('Countries')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.region.index')}}"><a class="sidebar-link"
                                                                                           href="{{route('admin.region.index')}}">@lang('Regions')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.city.index')}}"><a class="sidebar-link"
            ...
            <li class="sidebar-item {{routeActiveClass('admin.place*')}}">
                ...
                <ul id="places"
                    ...
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.place.create')}}"><a class="sidebar-link"
                                                                                           href="{{route('admin.place.create')}}">@lang('Create place')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.place.index')}}"><a class="sidebar-link"
            ...
            <li class="sidebar-item {{routeActiveClass('admin.accommodation*')}}">
                ...
                <ul id="accommodation"
                    ...
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.accommodation-type.*')}}"><a class="sidebar-link"
                                                                                                   href="{{route('admin.accommodation-type.index')}}">@lang('Accommodation Types')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.accommodation.*')}}"><a class="sidebar-link"
            ...
            <li class="sidebar-item {{routeActiveClass('admin.ticket*')}}">
                <a data-bs-target="#ticket" data-bs-toggle="collapse"
                   class="sidebar-link {{routeActiveClass('admin.ticket*', '', 'collapsed')}}">
                    <i class="align-middle" data-feather="file"></i> <span class="align-middle">@lang('Tickets')</span>
                </a>
                <ul id="ticket"
                    class="sidebar-dropdown list-unstyled collapse {{routeActiveClass('admin.ticket*', 'show', '')}}"
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.ticket.index')}}"><a class="sidebar-link"
                                                                                           href="{{route('admin.ticket.index')}}">@lang('List')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.ticket.create')}}"><a class="sidebar-link"
                                                                                            href="{{route('admin.ticket.create')}}">@lang('Create')</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item {{routeActiveClass('admin.staff*')}}">
                ...
                <ul id="staff"
                    ...
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.staff.index')}}"><a class="sidebar-link"
                                                                                          href="{{route('admin.staff.index')}}">@lang('Staff')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.staff-type.index')}}"><a class="sidebar-link"
            ...
            <li class="sidebar-item {{routeActiveClass('admin.discount*')}}">
                <a data-bs-target="#discount" data-bs-toggle="collapse"
                   class="sidebar-link {{routeActiveClass('admin.discount*', '', 'collapsed')}}">
                    <i class="align-middle" data-feather="percent"></i> <span
                        class="align-middle">@lang('Discounts')</span>
                </a>
                <ul id="discount"
                    class="sidebar-dropdown list-unstyled collapse {{routeActiveClass('admin.discount*', 'show', '')}}"
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.discount.index')}}"><a class="sidebar-link"
                                                                                             href="{{route('admin.discount.index')}}">@lang('Discount List')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.discount.create')}}"><a class="sidebar-link"
                                                                                              href="{{route('admin.discount.create')}}">@lang('Create Discount')</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item {{routeActiveClass('admin.document*')}}">
                <a data-bs-target="#document" data-bs-toggle="collapse"
                   class="sidebar-link {{routeActiveClass('admin.document*', '', 'collapsed')}}">
                    <i class="align-middle" data-feather="file"></i> <span
                        class="align-middle">@lang('Documents')</span>
                </a>
                <ul id="document"
                    class="sidebar-dropdown list-unstyled collapse {{routeActiveClass('admin.document*', 'show', '')}}"
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.document.index')}}"><a class="sidebar-link"
                                                                                             href="{{route('admin.document.index')}}">@lang('Document List')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.document.create')}}"><a class="sidebar-link"
                                                                                              href="{{route('admin.document.create')}}">@lang('Create Document')</a>
                    </li>
                </ul>
            </li>
            <!-- CONTENT --------------------------------------------------------------------------------------- --->
            ...
            <li class="sidebar-item {{routeActiveClass('admin.news*')}}">
                <a data-bs-target="#news" data-bs-toggle="collapse"
                   class="sidebar-link {{routeActiveClass('admin.news*', '', 'collapsed')}}">
                    <i class="align-middle" data-feather="rss"></i> <span class="align-middle">@lang('News')</span>
                </a>
                <ul id="news"
                    class="sidebar-dropdown list-unstyled collapse {{routeActiveClass('admin.news*', 'show', '')}}"
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.news.index')}}"><a class="sidebar-link"
                                                                                         href="{{route('admin.news.index')}}">@lang('News List')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.news.create')}}"><a class="sidebar-link"
                                                                                          href="{{route('admin.news.create')}}">@lang('Create News')</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item {{routeActiveClass('admin.html-block*')}}">
                <a data-bs-target="#html-block" data-bs-toggle="collapse"
                   class="sidebar-link {{routeActiveClass('admin.html-block*', '', 'collapsed')}}">
                    <i class="align-middle" data-feather="code"></i> <span
                        class="align-middle">@lang('Html Block')</span>
                </a>
                <ul id="html-block"
                    class="sidebar-dropdown list-unstyled collapse {{routeActiveClass('admin.html-block*', 'show', '')}}"
                    data-bs-parent="#sidebar">
                    <li class="sidebar-item {{routeActiveClass('admin.html-block.index')}}"><a class="sidebar-link"
                                                                                               href="{{route('admin.html-block.index')}}">@lang('Html Blocks List')</a>
                    </li>
                    <li class="sidebar-item {{routeActiveClass('admin.html-block.create')}}"><a class="sidebar-link"
                                                                                                href="{{route('admin.html-block.create')}}">@lang('Create Html Block')</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-header">
            ...
            <li class="sidebar-item {{routeActiveClass('log-viewer*')}}">
                ...
                <ul id="logs" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link"
                                                href="{{route('log-viewer::dashboard')}}">@lang('Dashboard')</a></li>
                    <li class="sidebar-item"><a class="sidebar-link"
                                                href="{{route('log-viewer::logs.list')}}">@lang('Logs')</a></li>
                </ul>
            </li>
