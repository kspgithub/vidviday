...
['url'=>route('admin.testimonial.questions'), 'title'=>__('Testimonials')],
['url'=>route('admin.testimonial.edit', $testimonial), 'title'=>__('Edit')],
    ...
    <div x-data="translatable()">
        <x-forms.patch :action="route('admin.testimonial.questions.update', $testimonial)" x-ref="form" enctype="multipart/form-data">
            <div>
