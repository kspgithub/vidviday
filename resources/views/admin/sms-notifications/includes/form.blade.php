...
<div x-data='translatable({share: {locales: @json($locales)}})'>
    ...
    <x-forms.text-loc-group name="title" :label="__('Title')" :value="old('title', $notification->getTranslations('title'))"/>

    <x-forms.textarea-loc-group name="text" :label="__('Text')" :value="old('text', $notification->getTranslations('text'))"/>
