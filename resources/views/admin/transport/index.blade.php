    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="d-flex align-items-center">
            @if(current_user()->isMasterAdmin())
                <a href="{{route('admin.transport.create')}}" class="btn btn-sm btn-outline-info"><i
            ...
            <table class="table table-responsive table-striped table-sm">
                ...
                @foreach($transports as $transport)
                    <tr>
                        ...
                        <td>{{app()->getLocale()}}</td>
                        <td><a href="{{route('admin.transport.media.index', ['transport'=>$transport])}}"
                               class="badge bg-info"><span>{{$transport->media_count}}</span></a></td>
