											...
											<div class="swiper-container" data-options='{"lazy": true, "autoHeight": true, "parallax": true, "speed": 900}'>
												<div class="swiper-wrapper lightbox-wrap">
													<div class="swiper-slide">
														<img src="{{ asset('img/preloader.png')}}" data-src="{{$tourGuides->image ?? asset('img/no-image.png')}}" alt="banner img 8" data-swiper-parallax="30%" class="swiper-lazy">
														<div class="full-size">
															<span>{{$tourGuides->title}}</span>
														</div>
													</div>
												</div>
											</div>
