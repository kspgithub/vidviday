            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-12">
                    ...
                    <form action="{{route('auth.login.store')}}" method="POST">
                        ...
                        <div class="spacer-xs"></div>
                        <x-seo-button key="auth.login" type="submit" class="btn type-1 btn-block">{{__('auth.sign-in')}}</x-seo-button>
                        <div class="text-center">
                            <div class="text">{{__('auth.or')}}</div>
                        </div>
                        <div class="spacer-xs"></div>
                        <x-seo-button key="auth.login_facebook" href="{{route('auth.social.login', 'facebook')}}" class="btn type-1 btn-block btn-fb">
                            ...
                            {{__('auth.sign-in-with')}} Facebook</x-seo-button>

                        <x-seo-button key="auth.login_google" href="{{route('auth.social.login', 'google')}}" class="btn type-1 btn-block btn-google">
                            ...
                            {{__('auth.sign-in-with')}} Google</x-seo-button>
                    </form>
                    <div class="spacer-xs"></div>
