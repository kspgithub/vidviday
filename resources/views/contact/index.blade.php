			...
			<div class="row">
				...
				<div class="order-xl-2 order-1 col-xl-9 col-12">
					...
					<div class="map-route-wrap">
                        @foreach($contacts as $map_item)
						<div class="map-block full-size" id="map-canvas" data-lat="{{$map_item->lat}}" data-lng="{{$map_item->lng}}" data-zoom="13" data-set-marker="svg/marker.svg')}}"></div>
						<div class="addresses-block">
							<a data-lat="{{$map_item->lat}}" data-lng="{{$map_item->lng}}" data-marker="img/marker.png')}}" data-string="<div class='map-informer-content'><p>{{$map_item->address}}{{$map_item->address_coment}}</p></div>"></a>
						</div>
						<form action="/" class="build-route">
							...
							<label>
								<input type="text" value="{{$map_item->address}}" disabled>
							</label>
						</form>
                        @endforeach
					</div>
									...
									<div class="thumb-wrap row">
										...
										<div class="col-lg-4 col-md-6 col-12">
											<div class="img img-border img-caption style-2">
												<div class="zoom">
													<img src="{{asset('img/preloader.png')}}" data-img-src="{{$specialist->avatar}}" alt="{{$specialist->first_name}}{{$specialist->last_name}}">
												...
												<div class="img-caption-info">
													<div class="guide-name">
														...
														<span class="text">{!! $specialist->types->implode('title') !!}</span>
														<br>
													...
													<div class="spacer-xs"></div>
													<a href="{{ route('office-worker', ['id'=>$specialist->id])}}" class="btn type-1 btn-block">Дізнатись більше</a>
												</div>
											</div>
										</div>
                                        @endforeach
								...
								<div class="accordion-inner">
									<div class="thumb-wrap row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            <div class="img img-border img-caption style-2">
                                                <div class="zoom">
                                                    <img src="{{asset('img/preloader.png')}}" data-img-src="{{$spec->avatar}}" alt="{{$spec->first_name}}{{$spec->last_name}}">
                                                    <a href="tour-guide.php" class="full-size"></a>
                                                </div>
                                                <div class="img-caption-info">
                                                    <div class="guide-name">
                                                        ...
                                                        <span class="text">{!! $spec->types->implode('title') !!}</span>
                                                        <br>
                                                        <span class="text">14 відгуків</span>
                                                    </div>
                                                    <hr>
