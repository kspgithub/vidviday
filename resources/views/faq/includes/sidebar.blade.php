    ...
    <div class="right-sidebar-inner">
        ...
        <div class="sidebar-item notice">
            ...
            <div class="bottom-part">
                ...
                <img loading="lazy" src="{{ asset("img/preloader.png") }}" data-src="img/transport-manager.png"
                    ...
                    <div class="review">
                        <div class="review-header">
                            <div class="review-img">
                                <img loading="lazy" src="{{ asset("img/preloader.png") }}" data-src="{{ asset("img/user.jpg") }}"
                                     alt="user">
                            </div>
                                        ...
                                        <div class="review-header">
                                            <div class="review-img">
                                                <img loading="lazy" src="{{ asset('img/preloader.png') }}"
                                                     data-src="{{ asset('img/user.jpg') }}" alt="user">
                                            </div>
                                            <div class="review-title">
                                                <span class="h4">Тетяна Вілсон</span>
                                                <span class="text text-sm">туроператор «Піраміда Тур»</span>
