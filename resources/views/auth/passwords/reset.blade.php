            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-5">
                    ...
                    <form action="{{route('auth.password.update')}}" method="POST">
                        ...
                        <label data-tooltip="@lang('forms.required')">
                            <i>@lang('forms.password-confirmation')*</i>
                        ...
                        <div class="spacer-xs"></div>
                        <div class="spacer-xs"></div>
                        <button v-bind="$buttons.auth.recover" type="submit" class="btn type-1 btn-block">@lang('auth.recover-password')</button>
                        <div class="spacer-xs"></div>
                        <div class="text-center">
                            <div class="text">або</div>
                        </div>
                        <div class="spacer-xs"></div>
                        <a v-bind="$buttons.auth.login_facebook" href="{{route('auth.social.login', 'facebook')}}" class="btn type-1 btn-block btn-fb">
                            ...
                            @lang('auth.sign-in-with') Facebook</a>
                        <div class="spacer-xs"></div>
                        <a v-bind="$buttons.auth.login_google" href="{{route('auth.social.login', 'google')}}" class="btn type-1 btn-block btn-google">
                            ...
                            @lang('auth.sign-in-with') Google</a>
                    </form>
                    <div class="spacer-xs"></div>
