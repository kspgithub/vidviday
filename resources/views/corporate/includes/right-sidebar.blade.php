                ...
                <div class="right-sidebar">
                    <div class="right-sidebar-inner">
                        <span class="btn font-lg type-1 btn-block open-popup calendar-init only-desktop only" data-rel="calendar-popup">Замовити корпоратив</span>
                        <div class="bordered-box only-desktop only">
                            <a href="document/document.pdf" download class="download">
                        ...
                        <div class="sidebar-item notice">
                            <div class="top-part">
                                <div class="title h3 light title-icon"><img src="img/preloader.png" data-img-src="icon/ring.svg" alt="ring">Контакти</div>
                            </div>
                            <div class="bottom-part">
                                <span class="text-md text-medium">Христина Чорній</span>
                                <br>
                                <span class="text-sm">спеціаліст з бронювання та керівник екскурсійних груп</span>
                                ...
                                <img src="img/preloader.png" data-img-src="img/transport-manager.png" alt="transport manager">
                            </div>
                        </div>
                        ...
                        <div class="sidebar-item testimonials">
                            <div class="top-part b-border">
                                <div class="title h3 title-icon">
                                    <img src="img/preloader.png" data-img-src="icon/reviews.svg" alt="reviews">
