                ...
                <div>
                    ...
                    <div style="position: relative; padding-left: 30px; margin-bottom: 12px;">
                        ...
                        <a href="{{phone_link($contact->phone_1)}}"
                           style="font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 24px; text-decoration: none; color: #626262;">{{$contact->phone_1}}</a>
                        <br>
                        <a href="{{phone_link($contact->phone_2)}}"
                           style="font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 24px; text-decoration: none; color: #626262;">{{$contact->phone_2}}</a>
                        <br>
                        <a href="{{phone_link($contact->phone_3)}}"
                           style="font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 24px; text-decoration: none; color: #626262;">{{$contact->phone_3}}</a>
                    </div>
                ...
                <div>
                    ...
                    <div style="position: relative; padding-left: 30px; margin-bottom: 12px;">
                        ...
                        <a href="geo:{{$contact->lat}},{{$contact->lng}}"
                           style="font-family: 'Roboto', sans-serif; font-size: 14px; line-height: 24px; text-decoration: none; color: #626262;">GPS:{{$contact->lat}} , {{$contact->lng}}</a>
                    </div>
