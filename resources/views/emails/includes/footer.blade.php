        ...
        <tr>
            <td style="vertical-align: top;">
                <div>
                    ...
                    <div style="position: relative; padding-left: 30px; margin-bottom: 12px;">
                        <img src="{{asset('icon/tel.png')}}" alt="tel"
                    ...
                    <div style="position: relative; padding-left: 30px; margin-bottom: 12px;">
                        <img src="{{asset('icon/smartphone.png')}}" alt="smartphone"
                             style="max-width: 18px; position: absolute; top: 5px; left: 0;">
                    ...
                    <div style="position: relative; padding-left: 30px; margin-bottom: 12px;">
                        <img src="{{asset('icon/email.png')}}" alt="email"
                        ...
                        @foreach(social_contacts($contact) as $key => $social)
                            <a href="{{$social['href']}}"
                               style="position: relative; display: inline-block; vertical-align: middle; {{ $loop->last ? '' : 'margin-right: 10px;' }}">
                                <img src="{{asset('icon/' . $social['icon'])}}" alt="skype"
            ...
            <td style="vertical-align: top;">
                <div>
                    ...
                    <div style="position: relative; padding-left: 30px; margin-bottom: 12px;">
                        <img src="{{asset('icon/placeholder.png')}}" alt="placeholder"
                    ...
                    <div style="position: relative; padding-left: 30px; margin-bottom: 12px;">
                        <img src="{{asset('icon/location.png')}}" alt="location"
