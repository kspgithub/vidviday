        ...
        <div class="row">
            <div class="col-xl-6 col">
                <form action="/" class="header-search">
                    ...
                    <div class="search-toggle">
                        <ul>
                            <li>
                                <div class="img">
                                    <img src="{{asset('/img/preloader.png')}}"
                                         data-img-src="{{asset('/img/preview_1.jpg')}}" alt="img">
                                </div>
                            ...
                            <li>
                                <div class="img">
                                    <img src="{{asset('/img/preloader.png')}}"
                                         data-img-src="{{asset('/img/preview_2.jpg')}}" alt="img">
                                </div>
                            ...
                            <li>
                                <div class="img">
                                    <img src="{{asset('/img/preloader.png')}}"
                                         data-img-src="{{asset('/img/preview_3.jpg')}}" alt="img">
                                </div>
                            ...
                            <li>
                                <div class="img">
                                    <img src="{{asset('/img/preloader.png')}}"
                                         data-img-src="{{asset('/img/preview_4.jpg')}}" alt="img">
                                </div>
                            ...
                            <li>
                                <div class="img">
                                    <img src="{{asset('/img/preloader.png')}}"
                                         data-img-src="{{asset('/img/preview_5.jpg')}}" alt="img">
                                </div>
                    ...
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="17.999px"
