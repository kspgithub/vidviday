...
InfoboxMin.prototype = new google.maps.OverlayView, InfoboxMin.prototype.createInfoBoxDiv_ = function () {
...
}, InfoboxMin.prototype.getCloseBoxImg_ = function () {
    var t = "";
...
}, InfoboxMin.prototype.addClickHandler_ = function () {
    var t;
...
}, InfoboxMin.prototype.setBoxStyle_ = function () {
    var t, i;
    if (this.div_) {
...
}, InfoboxMin.prototype.getBoxWidths_ = function () {
...
}, InfoboxMin.prototype.onRemove = function () {
    this.div_ && (this.div_.parentNode.removeChild(this.div_), this.div_ = null)
}, InfoboxMin.prototype.draw = function () {
...
}, InfoboxMin.prototype.setOptions = function (t) {
...
}, InfoboxMin.prototype.setContent = function (t) {
...
}, InfoboxMin.prototype.setPosition = function (t) {
    this.position_ = t, this.div_ && this.draw(), google.maps.event.trigger(this, "position_changed")
}, InfoboxMin.prototype.setZIndex = function (t) {
    this.zIndex_ = t, this.div_ && (this.div_.style.zIndex = t), google.maps.event.trigger(this, "zindex_changed")
}, InfoboxMin.prototype.setVisible = function (t) {
    this.isHidden_ = !t, this.div_ && (this.div_.style.visibility = this.isHidden_ ? "hidden" : "visible")
}, InfoboxMin.prototype.getContent = function () {
    return this.content_
}, InfoboxMin.prototype.getPosition = function () {
    return this.position_
}, InfoboxMin.prototype.getZIndex = function () {
    return this.zIndex_
}, InfoboxMin.prototype.getVisible = function () {
    return void 0 !== this.getMap() && null !== this.getMap() && !this.isHidden_
}, InfoboxMin.prototype.getWidth = function () {
    var t = null;
    return this.div_ && (t = this.div_.offsetWidth), t
}, InfoboxMin.prototype.getHeight = function () {
    var t = null;
    return this.div_ && (t = this.div_.offsetHeight), t
}, InfoboxMin.prototype.show = function () {
    this.isHidden_ = !1, this.div_ && (this.div_.style.visibility = "visible")
}, InfoboxMin.prototype.hide = function () {
    this.isHidden_ = !0, this.div_ && (this.div_.style.visibility = "hidden")
}, InfoboxMin.prototype.open = function (t, i) {
    var e = this;
...
}, InfoboxMin.prototype.close = function () {
    var t;
...
window.InfoBox = InfoboxMin;

export default InfoboxMin;
