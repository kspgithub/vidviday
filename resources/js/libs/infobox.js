...
if ('google' in window && 'maps' in google) {
    ...
    InfoBox.prototype.createInfoBoxDiv_ = function () {
        ...
        if (!this.div_) {
            if (
                this.div_ = document.createElement('div'), this.setBoxStyle_(), void 0 === this.content_.nodeType ?
                    this.div_.innerHTML = this.getCloseBoxImg_() + this.content_ :
                    (this.div_.innerHTML = this.getCloseBoxImg_(), this.div_.appendChild(this.content_)),
                    this.getPanes()[this.pane_].appendChild(this.div_),
                    this.addClickHandler_(),
                    this.div_.style.width ? this.fixedWidthSet_ = !0 : 0 !== this.maxWidth_ &&
                ...
                for (this.eventListeners_ = [],
                         i = ['mousedown', 'mouseover', 'mouseout', 'mouseup', 'click', 'dblclick', 'touchstart', 'touchend', 'touchmove'],
                         t = 0; t < i.length; t++)
