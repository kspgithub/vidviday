const MediaLibrary = function (selector) {
    ...
    const addMedia = (media, tmpNode) => {
        ...
        divEl.innerHTML = `<img data-src="${media.thumb}" alt=""><a href="#" class="delete-media-item"><i class="fas fa-times"></i></a>
    ...
    const uploadMedia = async (file) => {
        ...
        reader.onload = (pe) => {
            ...
            divEl.innerHTML = `<img data-src="${src}" alt=""><div class="spinner-border text-warning" role="status"></div>`;
