...
export default params => ({
    ...
    init() {
        ...
        this.$watch('participantData', data => {
            if (data.first_name) this.participantData.first_name = data.first_name.ucWords()

            if (data.last_name) this.participantData.last_name = data.last_name.ucWords()

            if (data.middle_name) this.participantData.middle_name = data.middle_name.ucWords()
        })

        this.$watch('order', order => {
            this.formChanged = true

            if (order.first_name) this.order.first_name = order.first_name.ucWords()

            if (order.last_name) this.order.last_name = order.last_name.ucWords()

            if (order.middle_name) this.order.middle_name = order.middle_name.ucWords()
    ...
    get childrenYoungFree() {
        return !!this.childrenDiscounts.find(
