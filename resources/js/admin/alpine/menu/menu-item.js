    ...
    onDropCh() {
        if (this.chDragging !== null && this.chDropping !== null) {
            if (this.chDragging < this.chDropping) {
                this.children = [...this.children.slice(0, this.chDragging), ...this.children.slice(this.chDragging + 1, this.chDropping + 1), this.children[this.chDragging], ...this.children.slice(this.chDropping + 1)];
            } else {
                this.children = [...this.children.slice(0, this.chDropping), this.children[this.chDragging], ...this.children.slice(this.chDropping, this.chDragging), ...this.children.slice(this.chDragging + 1)]
            }
