            ...
            <div ref="optWrapperRef" class="optWrapper">
                <ul class="options">
                    ...
                    <li v-for="option in filteredOptions"
                        v-show="(!option.value && selected.length) || option"
...
export default {
    ...
    setup(props, {emit}) {
        ...
        const filteredOptions = computed(() => {
            return ooptions.value.filter((o, i) => i === 0 || o.text.toLowerCase().indexOf(searchValue.value.toLowerCase()) > -1).map((o) => {
