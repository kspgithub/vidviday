        ...
        <div class="row">
            <div class="col-xl-8 col-12">
                <div class="row">
                    ...
                    <div v-if="user.role === 'tour-agent'" class="col-12">
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="col-md-6 col-12">
                        <form-input v-model="formData.viber" :label="__('forms.viber')" name="viber">
                            <tooltip v-if="user.role === 'tour-agent'"
                                >Ваш номер буде додано до турагентської <br />Вайбер-розсилки з акціями, новими турами,
                                даними <br />про наявність місць та іншою корисною інформацією
                            </tooltip>
                        </form-input>
                    </div>

                    <div v-if="user.provider" class="col-12">
                        <div class="spacer-xs"></div>
                        <span class="h4">Зареєстровано через</span>
                    </div>

                    <div v-if="user.provider" class="col-md-6 col-12">
