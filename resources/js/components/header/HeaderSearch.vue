<template>
    <form ref="formRef" action="/tours" class="header-search" :class="{ active: active }" @mouseleave="active = false">
        <input
            ref="searchRef"
            v-model="searchText"
            type="text"
        ...
        <div class="search-toggle">
            ...
            <div v-if="searchText.length >= 3 && !request && tours.length === 0" class="search-toggle-footer disabled">
        ...
        <div v-if="voiceSupport" class="voice-search-btn only-desktop" @click="openVoiceSearch()">
        ...
        <span v-if="voiceSupport" class="vertical-separator"></span>
