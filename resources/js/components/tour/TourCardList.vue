<template>
    <div class="item">
        <div class="thumb-img">
            <tour-badge
                v-for="(badge, idx) in tour.badges"
        ...
        <div class="d-flex align-items-start item-cnt">
            ...
            <div class="thumb-content">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="thumb-info ms-10">
                        ...
                        <span class="thumb-info-people text">
                            {{
                                currentSchedule?.places_available > 10
                                    ? '10+'
                                    : currentSchedule?.places_available < 2
                                    ? '0'
                                    : '2-10'
                            }}
                ...
                <template v-if="currentSchedule">
                    <a :href="tour.url + '/order?clear=1&schedule=' + scheduleId" class="btn type-1 btn-block">{{
                ...
                <template v-else>
                    ...
                    <div class="text text-center">
                        ...
                        <b
                            >{{ tour.votings_count }}
                            {{ $lang().choice('tours-section.persons', tour.votings_count) }}</b
                        >
                    </div>
