            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <vue-recaptcha v-if="useRecaptcha" :sitekey="sitekey"
                                   ...
                                   ref="recaptcha"
                    >
                        <seo-button code="tour.send_question" type="submit" class="btn type-1" :disabled="submitted" @click="validateForm">
                            {{ __('forms.send') }}
                        </seo-button>
                    </vue-recaptcha>
...
export default {
    ...
    components: {SeoButton, FormPhone, VueRecaptcha, Popup, FormTextarea, FormInput },
    props: {
        tour: Object,
        action: String,
        dataParent: Number,
