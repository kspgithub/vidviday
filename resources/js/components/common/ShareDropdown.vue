    ...
    <div class="share dropdown">
        ...
        <div class="dropdown-toggle">
            <div class="social style-1">
                ...
                <a :href="shareUrl" data-sharer="facebook" :data-url="shareUrl" ref="fbRef" @click.prevent="share">
                ...
                <a :href="shareUrl" data-sharer="twitter" :data-title="shareTitle" :data-url="shareUrl" ref="twRef"
                   @click.prevent="share">
