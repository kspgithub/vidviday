    ...
    <popup size="size-1" :active="popupOpen" @hide="closePopup()">
        ...
        >
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <form-input v-model="data.last_name" name="last_name" :label="__('forms.your-last-name')" />
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    >
                        ...
                        <option v-for="option in tours" :value="option.id" :data-img="option.img">
                            {{ option.title }}
                        </option>
                    </form-autocomplete>
                </div>
                ...
                <div class="col-12">
                    <form-textarea v-model="data.text" name="text" :label="__('forms.your-feedback')" />
                </div>
