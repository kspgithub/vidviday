...
let _a
const i18n = new lang_js_1.default(
    Object.assign(
        {
            fallback: document.documentElement.lang || navigator.language,
            messages:
                (_a = options === void 0 ? void 0 : options.messages) !== null && _a !== void 0
                    ? _a
...
function importTranslations({ ignore, globalTranslationsKey }) {
    ...
    files.keys().forEach(file => {
        ...
        const [isGlobal, rootLocale] =
            (_a = /\.\/([A-Za-z0-9-_]+).(?:php|json)/.exec(file)) !== null && _a !== void 0 ? _a : []
        if (isGlobal) {
        ...
        const [isScoped, locale, domain] =
            (_b = /\.\/([A-Za-z0-9-_]+)\/([A-Za-z0-9-_]+).(?:php|json)/.exec(file)) !== null && _b !== void 0 ? _b : []
